...
import { P as PageRouteSymbol, d as useRoute, f as appLayoutTransition, g as _wrapIf, L as LayoutMetaSymbol, a as useNuxtApp } from '../server.mjs';
import { useRoute as useRoute$1 } from 'vue-router';

const layouts = {
  default: () => import('./default-d601c611.mjs').then((m) => m.default || m)
};
...
//# sourceMappingURL=nuxt-layout-60cef919.mjs.map
