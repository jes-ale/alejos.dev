import { hasInjectionContext, getCurrentInstance, inject, defineComponent, h, onUnmounted, ref, computed, watch, Fragment, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, Text, defineAsyncComponent, isRef, effectScope, markRaw, isShallow, isReactive, toRaw, mergeProps, nextTick, useSlots, resolveComponent, onUpdated, Suspense, Transition, getCurrentScope, onScopeDispose } from 'vue';
import { f as useRuntimeConfig$1, m as withQuery, n as hasProtocol, p as parseURL, o as isScriptProtocol, j as joinURL, i as createError$1, $ as $fetch, q as sanitizeStatusCode, r as createHooks, t as isEqual, v as getRequestHeaders } from '../nitro/node-server.mjs';
...
const defaultNamespace = _globalThis[globalKey$1] || (_globalThis[globalKey$1] = createNamespace$1());
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index-5d997e81.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "page-id",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/page/:id()",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/_id_-a0fbc018.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_EyvDxPEabk = /* @__PURE__ */ defineNuxtPlugin({
...
const unhead_QxvorS9Hov = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
function resolveVariants(node, variantsRef) {
  ...
  if (target) {
    ...
    directivePropsKeys.forEach((key) => {
      ...
      if (key === "visible-once")
        key = "visibleOnce";
      if (target && target[key] && isObject$2(target[key]))
...
const motion_JIOPihgVZm = /* @__PURE__ */ defineNuxtPlugin(
  (nuxtApp) => {
    const { motion: options } = /* @__PURE__ */ useRuntimeConfig();
    nuxtApp.vueApp.use(MotionPlugin, options);
  }
);
const composition_4ssC6dNebt = /* @__PURE__ */ defineNuxtPlugin(() => {
});
/*!
  * shared v9.5.0
...
const i18n_zjMRxOV7rA = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
...
const plugins = [
  plugin$1,
  plugin,
  revive_payload_server_EyvDxPEabk,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-1c580f2e.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-48493d11.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.7.0_sass@1.66.1/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-08cef852.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.7.0_sass@1.66.1/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, useNuxtApp as a, useRequestFetch as b, createError as c, useRoute as d, entry$1 as default, useRuntimeConfig as e, appLayoutTransition as f, _wrapIf as g, navigateTo as n, useRouter as u };
